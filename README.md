...
We suggest running all examples on Google Colab. All examples are built and tested using Google Colab, so it should be the most stable platform. However, you can also use <img src="https://jupyter.org/assets/homepage/main-logo.svg" width="20"> Jupyter Notebook to run all examples. 
to run all examples. 
